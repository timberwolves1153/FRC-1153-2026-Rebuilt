...
public class TunerConstants {
  ...
  private static final Slot0Configs driveGains =
      new Slot0Configs().withKP(60).withKI(0).withKD(0).withKS(7.26).withKV(0);
      ...
      new TalonFXConfiguration()
          .withCurrentLimits(
              new CurrentLimitsConfigs()
                  // Swerve azimuth does not require much torque output, so w/e can set a relatively
                  // low
  ...
  // This needs to be tuned to your individual robot
  public static final LinearVelocity kSpeedAt12Volts = MetersPerSecond.of(0.75);
  ...
  private static final Angle kFrontRightEncoderOffset = Rotations.of(0.360595703125);
  ...
  private static final Angle kBackLeftEncoderOffset = Rotations.of(0.45849609375);
