...
public class LauncherIOTalonFX implements LauncherIO {
  ...
  public void configMotors() {
    ...
    turretConfig.Feedback.RotorToSensorRatio = 6; // subject to change
  ...
  public void updateInputs(LauncherIOInputs launcherInputs) {
    ...
    launcherInputs.turretPositionRotations = turretEncoder.getAbsolutePosition().getValueAsDouble();
  ...
  public void setTurretPositionRotaions(double rotations) {
    rotations = MathUtil.clamp(rotations, 0, 0); // TODO: Set max and min
    turretMotor.setControl(turretMotionMagic.withPosition(rotations));
  }
}
